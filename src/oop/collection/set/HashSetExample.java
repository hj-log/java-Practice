...
public class HashSetExample {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         - 다시 원래 값으로 돌아갈 수 없는 단방향성 알고리즘 (복구화 할 수 없음)
       ...
       // 객체를 저장: add(객체) - 중복 객체를 허용하지 않는다.
        ...
        // 리스트나 set 크기를 마음대로 늘이거나 줄일 수 없습니다.
        ...
        Set<String> convertSet = new HashSet<>(convertedList);
        System.out.println("convertSet = " + convertSet);
