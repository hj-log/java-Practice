...
import oop.inner_anonymous.printer.*;
import oop.inner_anonymous.domain.*;
import oop.inner_anonymous.exception.*;
import oop.inner_anonymous.service.*;
...
public class SprintLogApp {
    ...
    public static void main(String[] args) {
        ...
        // ActivityDashboard.Summary()를 호출해서 리턴 받음.
