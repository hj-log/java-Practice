...
import oop.stream.repository.*;
import oop.stream.service.*;
...
public class SprintLogApp {
    ...
    public static void main(String[] args) {
        ...
        Map<Boolean, List<LearningActivity>> byVisibility = activities.stream()
                            .collect(Collectors.partitioningBy
                            (a-> a.getvisibility() == Visibility.PUBLIC));
         ...
         */
        double avgMinutes = activities.stream()
                                .mapToInt(LearningActivity::getMinutes)
                                .average()
                                .getAsDouble();
         ...
         */
        LearningActivity longestActivity = activities.stream()
                                                .max(Comparator.comparingInt(LearningActivity::getMinutes))
                                                .get();
         ...
         */
        Map<ActivityCategory, Map<Boolean, Long>> grouped = activities.stream()
                .collect(Collectors.groupingBy(LearningActivity::getCategory,
                        Collectors.groupingBy(LearningActivity::isPublicActivity,Collectors.counting()
                        )));
